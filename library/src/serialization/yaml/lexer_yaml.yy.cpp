      ...
      case INITIAL:
        ...
        switch (matcher().scan())
        {
          case 0:
            ...
            break;
          case 1: // rule library/lexers/yaml.l:198: {direct} :
{ /* ignore directive */ }
            break;
          case 2: // rule library/lexers/yaml.l:199: {comment} :
{ /* ignore comment */ }
            break;
          case 3: // rule library/lexers/yaml.l:200: \h* {lf} :
{ return ';'; }
            break;
          case 4: // rule library/lexers/yaml.l:201: \h* {bl} :
{ return '='; }
            break;
          case 5: // rule library/lexers/yaml.l:202: ^ \h+ \i :
{ return '>'; }
            break;
          case 6: // rule library/lexers/yaml.l:203: ^ \h+ \j :
          case 7: // rule library/lexers/yaml.l:204: \j :
{ return '<'; }
            break;
          case 8: // rule library/lexers/yaml.l:205: \h+ :
{ /* ignore spaces and tabs */ }
            break;
          case 9: // rule library/lexers/yaml.l:206: "---" {br} :
{ return 'S'; }
            break;
          case 10: // rule library/lexers/yaml.l:207: "..." {br} :
{ return 'E'; }
            break;
          case 11: // rule library/lexers/yaml.l:208: "-" :
{ return '-'; }
            break;
          case 12: // rule library/lexers/yaml.l:209: "?" :
{ return '?'; }
            break;
          case 13: // rule library/lexers/yaml.l:210: ":" :
{ return ':'; }
            break;
          case 14: // rule library/lexers/yaml.l:211: "," :
{ return ','; }
            break;
          case 15: // rule library/lexers/yaml.l:212: "[" :
{ return '['; }
            break;
          case 16: // rule library/lexers/yaml.l:213: "]" :
{ return ']'; }
            break;
          case 17: // rule library/lexers/yaml.l:214: "{" :
{ return '{'; }
            break;
          case 18: // rule library/lexers/yaml.l:215: "}" :
{ return '}'; }
            break;
          case 19: // rule library/lexers/yaml.l:216: "'" :
{ clear(); start(APOS); }
            break;
          case 20: // rule library/lexers/yaml.l:217: \" :
{ clear(); start(QUOT); }
            break;
          case 21: // rule library/lexers/yaml.l:218: "|"  \d* {nl} :
{ clear(); parse_indent(1); mode = CLIP;  start(PRES); }
            break;
          case 22: // rule library/lexers/yaml.l:219: "|-" \d* {nl} :
{ clear(); parse_indent(2); mode = STRIP; start(PRES); }
            break;
          case 23: // rule library/lexers/yaml.l:220: "|+" \d* {nl} :
{ clear(); parse_indent(2); mode = KEEP;  start(PRES); }
            break;
          case 24: // rule library/lexers/yaml.l:221: ">"  \d* {nl} :
{ clear(); parse_indent(1); mode = CLIP;  start(FOLD); }
            break;
          case 25: // rule library/lexers/yaml.l:222: ">-" \d* {nl} :
{ clear(); parse_indent(2); mode = STRIP; start(FOLD); }
            break;
          case 26: // rule library/lexers/yaml.l:223: ">+" \d* {nl} :
{ clear(); parse_indent(2); mode = KEEP;  start(FOLD); }
            break;
          case 27: // rule library/lexers/yaml.l:224: {tag} :
{ _word = str(); return chr(); }
            break;
          case 28: // rule library/lexers/yaml.l:225: {scalar} :
{ _word = str(); return '$'; }
      ...
      case APOS:
        ...
        switch (matcher().scan())
        {
          case 0:
            ...
            break;
          case 1: // rule library/lexers/yaml.l:228: ' :
{ start(INITIAL); return '$'; }
            break;
          case 2: // rule library/lexers/yaml.l:229: '' :
{ add('\''); }
            break;
          case 3: // rule library/lexers/yaml.l:255: ^ \h+ \k? :
{ /* ignore nodent/undent */ }
            break;
          case 4: // rule library/lexers/yaml.l:256: \h* {lf} :
{ add(' '); }
            break;
          case 5: // rule library/lexers/yaml.l:257: {bl} :
{ add('\n', newlines() - 1); }
            break;
          case 6: // rule library/lexers/yaml.l:258: . :
{ add(wchr()); }
            break;
        }
        break;
      case QUOT:
        ...
        switch (matcher().scan())
        {
          case 0:
            ...
            break;
          case 1: // rule library/lexers/yaml.l:233: \\ {lf} :
{ /* ignore \LF */ }
            break;
          case 2: // rule library/lexers/yaml.l:234: \" :
{ start(INITIAL); return '$'; }
            break;
          case 3: // rule library/lexers/yaml.l:235: \\ 0 :
{ add('\0'); }
            break;
          case 4: // rule library/lexers/yaml.l:236: \\ a :
{ add('\a'); }
            break;
          case 5: // rule library/lexers/yaml.l:237: \\ b :
{ add('\b'); }
            break;
          case 6: // rule library/lexers/yaml.l:238: \\ t :
{ add('\t'); }
            break;
          case 7: // rule library/lexers/yaml.l:239: \\ n :
{ add('\n'); }
            break;
          case 8: // rule library/lexers/yaml.l:240: \\ v :
{ add('\v'); }
            break;
          case 9: // rule library/lexers/yaml.l:241: \\ f :
{ add('\f'); }
            break;
          case 10: // rule library/lexers/yaml.l:242: \\ r :
{ add('\r'); }
            break;
          case 11: // rule library/lexers/yaml.l:243: \\ e :
{ add(0x1b); }
            break;
          case 12: // rule library/lexers/yaml.l:244: \\ N :
{ add(0x85); }
            break;
          case 13: // rule library/lexers/yaml.l:245: \\ _ :
{ add(0xa0); }
            break;
          case 14: // rule library/lexers/yaml.l:246: \\ L :
{ add(0x2028); }
            break;
          case 15: // rule library/lexers/yaml.l:247: \\ P :
{ add(0x2029); }
            break;
          case 16: // rule library/lexers/yaml.l:248: \\ x {h2} :
{ add(strtoul(text() + 2, NULL, 16)); }
            break;
          case 17: // rule library/lexers/yaml.l:249: \\ u {h4} :
{ add(strtoul(text() + 2, NULL, 16)); }
            break;
          case 18: // rule library/lexers/yaml.l:250: \\ U {h8} :
{ add(strtoul(text() + 2, NULL, 16)); }
            break;
          case 19: // rule library/lexers/yaml.l:251: \\ . :
{ add(str()[1]); }
            break;
          case 20: // rule library/lexers/yaml.l:255: ^ \h+ \k? :
{ /* ignore nodent/undent */ }
            break;
          case 21: // rule library/lexers/yaml.l:256: \h* {lf} :
{ add(' '); }
            break;
          case 22: // rule library/lexers/yaml.l:257: {bl} :
{ add('\n', newlines() - 1); }
            break;
          case 23: // rule library/lexers/yaml.l:258: . :
{ add(wchr()); }
            break;
        }
        break;
      case PRES:
        ...
        switch (matcher().scan())
        {
          case 0:
            ...
            break;
          case 1: // rule library/lexers/yaml.l:262: ^ \h+ \i :
      ...
      case FOLD:
        ...
        switch (matcher().scan())
        {
          case 0:
            ...
            break;
          case 1: // rule library/lexers/yaml.l:266: ^ \h+ \i :
      ...
      case PBLK:
        ...
        switch (matcher().scan())
        {
          case 0:
            ...
            break;
          case 1: // rule library/lexers/yaml.l:270: {lf} :
{ add('\n'); }
            break;
          case 2: // rule library/lexers/yaml.l:271: {bl} :
{ add('\n', newlines()); }
            break;
          case 3: // rule library/lexers/yaml.l:272: ^ \h* \j :
          case 4: // rule library/lexers/yaml.l:273: \j :
{ chomp(); start(INITIAL); return '$'; }
            break;
          case 5: // rule library/lexers/yaml.l:274: ^ \h+ :
{ }
            break;
          case 6: // rule library/lexers/yaml.l:275: ^ \h+ \k :
{ add_indent(); }
            break;
          case 7: // rule library/lexers/yaml.l:276: . :
{ add(chr()); }
            break;
        }
        break;
      case FBLK:
        ...
        switch (matcher().scan())
        {
          case 0:
            ...
            break;
          case 1: // rule library/lexers/yaml.l:280: \h+ {lf} :
{ sp = size() - 1 - (*(matcher().end() - 2) == '\r'); }
            break;
          case 2: // rule library/lexers/yaml.l:281: {lf} :
{ sp = 1; }
            break;
          case 3: // rule library/lexers/yaml.l:282: {bl} :
{ add('\n', newlines() - 1); }
            break;
          case 4: // rule library/lexers/yaml.l:283: ^ \h* \j :
          case 5: // rule library/lexers/yaml.l:284: \j :
{ chomp(); start(INITIAL); return '$'; }
            break;
          case 6: // rule library/lexers/yaml.l:285: ^ \h+ :
{ add_newline(); }
            break;
          case 7: // rule library/lexers/yaml.l:286: ^ \h+ \k :
{ sp = 0; nl = true; add_indent(); }
            break;
          case 8: // rule library/lexers/yaml.l:287: . :
{ add_space(); add(chr()); }
            break;
        }
        break;
