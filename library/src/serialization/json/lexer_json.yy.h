// ./../src/serialization/json/lexer_json.yy.h generated by reflex 3.0.11 from ./json.l

#ifndef REFLEX______SRC_SERIALIZATION_JSON_LEXER_JSON_YY_H
#define REFLEX______SRC_SERIALIZATION_JSON_LEXER_JSON_YY_H
#define IN_HEADER 1
